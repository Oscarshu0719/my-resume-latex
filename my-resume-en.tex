...
\section{EDUCATION}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Computer Science}{Hangzhou, China}
      \resumeItemListStart
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\normalsize{Improved \href{https://arxiv.org/pdf/1704.00028}{WGAN-GP} to solve mode collapse problem, vanishing gradient problem, and bad results of some audio tracks.}}
        \resumeItem{\normalsize{Proposed three distinct loss functions, element-wise, discriminator dominant, and hybrid.}}
      \resumeItemListEnd 
      % \vspace{-13pt}
    ...
    \resumeSubheading
      ...
      {}{Hangzhou, China}
      \resumeItemListStart
        \resumeItem{\normalsize{Improved \href{https://arxiv.org/pdf/1907.12279}{StarGAN-VC2} based on multi-speaker non-parallel corpus.}}
        \resumeItem{\normalsize{Introduced \href{https://arxiv.org/pdf/1712.01026}{WGAN-div} to resolve k-Lipschitz constraint of \href{https://arxiv.org/pdf/1701.07875}{WGAN}.}}
        \resumeItem{\normalsize{Provided new generator network by replacing \href{https://arxiv.org/pdf/1610.07629}{cIN} layer with trainable \href{https://arxiv.org/pdf/1703.06868}{AdaIN} layer for better performance.}}
        \resumeItem{\normalsize{Introduced neural vocoder, \href{https://arxiv.org/pdf/1811.00002}{WaveGlow}, to generate high quality speech from mel-spectrograms.}}
      \resumeItemListEnd 
      % \vspace{-13pt}
  \resumeSubHeadingListEnd
\vspace{-12pt}
...
\section{AWARDS}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Gold Medal Award}{Hangzhou, China}
